<aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile" style="background: url(../assets/images/background/user-info.jpg) no-repeat;">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="" alt="<?php echo $_SESSION['persona'] ?>" /> </div>
                    <!-- User profile text-->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">menu </span></a>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-laptop-windows"></i><span class="hide-menu"> Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="#"></a>menu</li>
                                <li><a href="#"></a>menu</li>
                                <li><a href="#"> </a>menu</li>
                                <li><a href="#l"> </a>menu</li>
                                <li><a href="#"></a>menu</li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Aplicaciones</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu"></span>menu</a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="#">menu</a></li>
                                <li><a href="#l">menu</a></li>
                                <li><a href="#">menu</a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Consultas</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Consultas</span></a>
                            <ul aria-expanded="false" class="collapse">
